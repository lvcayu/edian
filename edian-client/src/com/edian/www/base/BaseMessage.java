...
public class BaseMessage {
	...
	public BaseMessage () {
		...
		this.ModelnameMap = new HashMap<String,String>(10);
		ModelnameMap.put("UserMe", "User");
		ModelnameMap.put("UserYou", "User");
		ModelnameMap.put("User", "User");
		ModelnameMap.put("Notice", "Notice");
		ModelnameMap.put("Share", "Share");
		ModelnameMap.put("Square", "Square");
		ModelnameMap.put("Inform", "Inform");
	}
	...
	public void setResult (String result) throws Exception {
		...
		if (result.length() > 0) {
			...
			while (it.hasNext()) {
				...
				String modelName = ModelnameMap.get(getModelName(jsonKey));
				String modelClassName = "com.edian.www.model." + modelName;
	...
	private BaseModel json2model (String modelClassName, JSONObject modelJsonObject) throws Exception  {
		...
		Log.i("ModelName", modelClassName);
